        ...
        <template v-for="(item, index) in form" :key="index">
            <div class="d-flex col-3 rounded-5 mt-3 mx-5" style="justify-content: center;border: 3px solid green;background-color: rgb(204, 246, 242);">
                <div data-bs-toggle="modal" data-bs-target="#ViewCommendModal" @click="viewDetail(item.id)">
                    <div style="border: 2px solid green;background-color: yellowgreen;width: 60px;height: 60px;border-radius: 50%;text-align: center;padding-top: 17px;font-weight: bold;">
                    {{ item.spellname }}
                    </div>
